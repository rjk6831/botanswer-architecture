...
<sub>Measured from the private product repository at commit `857a06eb` (2026-09-24); refreshed 2026-09-24. 522,467 lines of code in total across application, tests, migrations, and infrastructure; 895 commits since 2026-07-01, 638 in the last 30 days. Test cases: Vitest, 277 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
