...
<sub>Measured from the private product repository at commit `5f71cda` (2026-09-14); refreshed 2026-09-14. 496,170 lines of code in total across application, tests, migrations, and infrastructure; 739 commits since 2026-07-01, 502 in the last 30 days. Test cases: Vitest, 186 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
