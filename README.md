...
<sub>Measured from the private product repository at commit `d9dfed0` (2026-09-15); refreshed 2026-09-14. 502,365 lines of code in total across application, tests, migrations, and infrastructure; 757 commits since 2026-07-01, 514 in the last 30 days. Test cases: Vitest, 205 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
