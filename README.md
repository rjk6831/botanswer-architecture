...
|---:|---:|---:|---:|---:|
| **243,928** lines | **170,516** lines in 559 files | **4,420** declared | **130** forward-only D1 SQL | **5** catalogs, 3,518 keys |

<sub>Measured from the private product repository at commit `114da29` (2026-09-10); refreshed 2026-09-10. 449,876 lines of code in total across application, tests, migrations, and infrastructure; 624 commits since 2026-07-01, 411 in the last 30 days. Test cases: Vitest, 150 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
