...
|---:|---:|---:|---:|---:|
| **291,238** lines | **198,218** lines in 740 files | **5,374** declared | **157** forward-only D1 SQL | **5** catalogs, 4,316 keys |

<sub>Measured from the private product repository at commit `9a0db841` (2026-09-25); refreshed 2026-09-25. 535,826 lines of code in total across application, tests, migrations, and infrastructure; 916 commits since 2026-07-01, 651 in the last 30 days. Test cases: Vitest, 293 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
