...
<sub>Measured from the private product repository at commit `cdb92e11` (2026-09-25); refreshed 2026-09-25. 535,826 lines of code in total across application, tests, migrations, and infrastructure; 917 commits since 2026-07-01, 652 in the last 30 days. Test cases: Vitest, 293 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
