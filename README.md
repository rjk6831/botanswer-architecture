...
|---:|---:|---:|---:|---:|
| **287,374** lines | **194,601** lines in 720 files | **5,260** declared | **156** forward-only D1 SQL | **5** catalogs, 4,263 keys |

<sub>Measured from the private product repository at commit `aab90b42` (2026-09-24); refreshed 2026-09-24. 522,467 lines of code in total across application, tests, migrations, and infrastructure; 896 commits since 2026-07-01, 639 in the last 30 days. Test cases: Vitest, 277 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
