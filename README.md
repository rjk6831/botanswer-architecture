...
<sub>Measured from the private product repository at commit `06bb648` (2026-09-10); refreshed 2026-09-10. 449,876 lines of code in total across application, tests, migrations, and infrastructure; 623 commits since 2026-07-01, 410 in the last 30 days. Test cases: Vitest, 150 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
