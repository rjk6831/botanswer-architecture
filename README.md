...
|---:|---:|---:|---:|---:|
| **252,141** lines | **174,537** lines in 577 files | **4,504** declared | **134** forward-only D1 SQL | **5** catalogs, 3,617 keys |

<sub>Measured from the private product repository at commit `01cc316` (2026-09-11); refreshed 2026-09-10. 463,284 lines of code in total across application, tests, migrations, and infrastructure; 667 commits since 2026-07-01, 454 in the last 30 days. Test cases: Vitest, 161 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
