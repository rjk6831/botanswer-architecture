...
|---:|---:|---:|---:|---:|
| **276,836** lines | **186,865** lines in 653 files | **4,922** declared | **149** forward-only D1 SQL | **5** catalogs, 4,240 keys |

<sub>Measured from the private product repository at commit `c744325` (2026-09-15); refreshed 2026-09-14. 502,365 lines of code in total across application, tests, migrations, and infrastructure; 758 commits since 2026-07-01, 515 in the last 30 days. Test cases: Vitest, 205 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
