...
|---:|---:|---:|---:|---:|
| **287,354** lines | **194,201** lines in 717 files | **5,250** declared | **156** forward-only D1 SQL | **5** catalogs, 4,263 keys |

<sub>Measured from the private product repository at commit `15aa9036` (2026-09-24); refreshed 2026-09-24. 521,778 lines of code in total across application, tests, migrations, and infrastructure; 887 commits since 2026-07-01, 630 in the last 30 days. Test cases: Vitest, 271 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
