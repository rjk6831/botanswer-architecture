...
|---:|---:|---:|---:|---:|
| **288,030** lines | **195,764** lines in 725 files | **5,293** declared | **156** forward-only D1 SQL | **5** catalogs, 4,268 keys |

<sub>Measured from the private product repository at commit `cb7abb33` (2026-09-25); refreshed 2026-09-24. 529,486 lines of code in total across application, tests, migrations, and infrastructure; 907 commits since 2026-07-01, 646 in the last 30 days. Test cases: Vitest, 290 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
