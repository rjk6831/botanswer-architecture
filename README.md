...
|---:|---:|---:|---:|---:|
| **277,868** lines | **187,962** lines in 661 files | **4,961** declared | **150** forward-only D1 SQL | **5** catalogs, 4,263 keys |

<sub>Measured from the private product repository at commit `366054b` (2026-09-15); refreshed 2026-09-15. 504,529 lines of code in total across application, tests, migrations, and infrastructure; 772 commits since 2026-07-01, 528 in the last 30 days. Test cases: Vitest, 208 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
