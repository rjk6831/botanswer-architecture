...
|---:|---:|---:|---:|---:|
| **243,928** lines | **170,452** lines in 558 files | **4,419** declared | **130** forward-only D1 SQL | **5** catalogs, 3,518 keys |

<sub>Measured from the private product repository at commit `82f4768` (2026-09-10); refreshed 2026-09-10. 449,817 lines of code in total across application, tests, migrations, and infrastructure; 622 commits since 2026-07-01, 409 in the last 30 days. Test cases: Vitest, 150 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
