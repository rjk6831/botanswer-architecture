...
<sub>Measured from the private product repository at commit `c968bd3` (2026-09-11); refreshed 2026-09-11. 467,493 lines of code in total across application, tests, migrations, and infrastructure; 675 commits since 2026-07-01, 459 in the last 30 days. Test cases: Vitest, 162 parameterized tables expand at run time. Counting rules and the workflow that keeps this current: <a href="metrics/README.md">metrics/README.md</a>.</sub>
<!-- metrics:end -->
